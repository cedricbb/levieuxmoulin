...
export default function ErrorScreen({ message, onRetry }: ErrorScreenProps) {
  return (
    <View className="flex-1 items-center justify-center bg-base-100 p-6">
      ...
      <Text className="font-serif-bold text-xl text-secondary mt-4 mb-2">Une erreur est survenue</Text>
      <Text className="font-sans text-base text-neutral text-center mb-6">{message}</Text>
